...
int main() {
    ...
    rt::RendererGPU rendererGPU(screen_settings);
    std::println("[INFO] RendererGPU is initialized");
    std::println("[INFO] RendererGPU is running");
    auto start = std::chrono::high_resolution_clock::now();
    rendererGPU.run();
    std::println("[INFO] RendererGPU has finished");
